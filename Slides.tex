...
\begin{frame}{Budgeted Utility Maximization}
	\begin{columns}
          \column{0.38\linewidth}
             \centering
             \includegraphics[height=5cm, width=5cm]{AMUPOL}
           \column{0.58\linewidth}
             
	 \centering
             \includegraphics[height=5cm, width=5cm]{AMUSIM}
         \end{columns} 
\end{frame}
...
\begin{columns}
          \column{0.38\linewidth}
             \centering
             \includegraphics[height=5cm, width=5cm]{Gini-Coefficient__10_Candidates}
           \column{0.58\linewidth}
             
	 \centering
             \includegraphics[height=5cm, width=5cm]{Gini-Coefficient__20_Candidates}
         \end{columns} 
\end{frame}
...
\begin{itemize}
\item No rule can be treated as 
\end{itemize}
\begin{itemize}
\item
\end{itemize}
