...
Code is in the python directory and can be run via the command line
    ...
    python3 CR.py --cost 0 --rule 0 --budget 100 --preferences test_preferences.txt
...
To generate ballots and save to file 'random_profile.txt'
    ...
    python3 CR.py --preferences random_profile.txt --write --voters 11 --candidates 10 --swaps 1 --noise 2 --base 3